...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ClientDesk — Client portals for freelancers" },
      { name: "description", content: "Manage projects and give clients a polished private portal with ClientDesk." },
      { name: "author", content: "ClientDesk" },
      { property: "og:title", content: "ClientDesk — Client portals for freelancers" },
      { property: "og:description", content: "Manage projects and give clients a polished private portal with ClientDesk." },
